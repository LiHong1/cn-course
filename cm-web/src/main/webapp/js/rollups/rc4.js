...
(function () {
    var s = CryptoJS, l = s.lib, e = l.Base, n = l.WordArray, l = s.algo, p = l.EvpKDF = e.extend({
        cfg: e.extend({
            keySize: 4,
            hasher: l.MD5,
            iterations: 1
...
CryptoJS.lib.Cipher || function (s) {
    var l = CryptoJS, e = l.lib, n = e.Base, p = e.WordArray, b = e.BufferedBlockAlgorithm, d = l.enc.Base64, t = l.algo.EvpKDF, q = e.Cipher = b.extend({
        cfg: n.extend(), createEncryptor: function (a, f) {
    ...
    var w = e.CipherParams = n.extend({
        ...
        cfg: n.extend({format: a}), encrypt: function (a, b, c, d) {
            d = this.cfg.extend(d);
...
(function () {
    ...
    var l = CryptoJS, e = l.lib.StreamCipher, n = l.algo, p = n.RC4 = e.extend({
        _doReset: function () {
    ...
    n = n.RC4Drop = p.extend({
        cfg: p.cfg.extend({drop: 192}), _doReset: function () {
