//package cn.commons.converter.pdfConverter;
////需要导入jcom。jar JCom是日本的一个开源项目，其是为了让java程序能够访问windows平台上的COM组件，利用JCom,可以在java中控制几乎所有的
////的Com对象
//
//import cn.commons.util.FileUtils;
