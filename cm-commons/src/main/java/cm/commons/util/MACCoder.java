...
public final class MACCoder {
     ...
     * @throws Exception
     */
    public static byte[] encodeHmacSHA(byte[] data, byte[] key) throws GeneralSecurityException {
        // 还原密钥
     ...
     * @throws Exception
     */
    public static byte[] encodeHmacSHA256(byte[] data, byte[] key) throws GeneralSecurityException {
        // 还原密钥
     ...
     * @throws Exception
     */
    public static byte[] encodeHmacSHA384(byte[] data, byte[] key) throws GeneralSecurityException {
        // 还原密钥
