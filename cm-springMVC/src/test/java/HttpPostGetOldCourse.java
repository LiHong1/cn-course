...
public class HttpPostGetOldCourse {
		...
		public static void main(String[] args){
			...
			try{
				...
				urlConnection.setRequestProperty("Cookie",
						"JwOAUserSettingNew=UserNum=H2WCSQThTI8=&UserName=M0y4ZTAC+lYcMIX+h+m1pg==&UserType=h4/SEBPSa9Q=&UserLoginTime=2015/6/4 20:29:44&GroupID=R16RIkC3cEk=&UnitID=aRpgHYmrsMs=" );
				// 得到请求的输出流对象
				...
				if(userType.equals("student"))
				 ...
				 idFilter = new HasAttributeFilter( "id", "_ctl1_dgTeacherLesson" );
					...
					for(int i = 1; i < trNodes.size(); i++) {
						{
							...
							NodeList tdNodes = tdParser.extractAllNodesThatMatch(tdFilter);
								...
								System.out.println("================");
								if(userType.equals("student")){
									//System.out.println(tdNodes.elementAt(j).toHtml());
									...
									//System.out.println(tdNodes.elementAt(j).toHtml());
									System.out.println("课程名称："+getText(tdNodes.elementAt(0).toHtml()));
									System.out.println("班级名称："+getText(tdNodes.elementAt(1).toHtml()));
