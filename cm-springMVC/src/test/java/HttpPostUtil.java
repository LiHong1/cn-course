...
public class HttpPostUtil {
		...
		public static void main(String[] args){
			try{
				...
				//url = new URL("http://localhost:8080/cm-springMVC/login");
				...
				out.write("__EVENTTARGET=&__EVENTARGUMENT=&__LASTFOCUS=&__VIEWSTATE=%2FwEPDwUJNjk1MjA1MTY0D2QWAgIBD2QWBAIBD2QWB" +
						...
						"%2BeuUqg4C2tqumwgC0sXgkQ8CuLeX%2BQECj8jxgAoRQcvVbiCAwXxJW8rVX6vT%2F4ywlHmBLMltZTQFLhvEWw%3D%3D&rblUserType" +
						"=Student&ddlCollege=180+++++&StuNum=1208066030&TeaNum=&Password=921026&login=%E7%99%BB%E5%BD%95" );
				out.flush();
				out.close();
				...
				System.out.println(urlConnection.getHeaderField(4));
				System.out.println(urlConnection.getHeaderField(5));
