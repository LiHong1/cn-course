 ...
 */
public class CmSimpleUrlAuthenticationFailureHandler implements AuthenticationFailureHandler {
	...
	public CmSimpleUrlAuthenticationFailureHandler() {
	}

	public CmSimpleUrlAuthenticationFailureHandler(String defaultFailureUrl) {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		if(request.getParameter("loginUrl") != null && !"".equals(request.getParameter("loginUrl"))){
			defaultFailureUrl = request.getContextPath()+"/backlogin.html?validated=false";
		}
		...
		if (defaultFailureUrl == null) {
			...
			if (forwardToDestination) {
				...
				redirectStrategy.sendRedirect(request, response, defaultFailureUrl+"?error=1");
			}
		}
	}
