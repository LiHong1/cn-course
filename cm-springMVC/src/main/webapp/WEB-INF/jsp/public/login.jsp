...
<html>
  <head>
     <title>登录</title>
      ...
      <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/style/css/login.css">
  </head>
   ...
   $(function(){
      ...
      $("#login").click(function(){
	     ...
	     /* $("#number").blur(function(){
	    	    ...
	    	    $.post("getCourse",{number:$("#number").val()},function(data){
		                 for(var temp in data){
		            	   alert(data[temp].id+"");
		                	u1_input[0].options.add(new Option(data[temp].name,data[temp].id));
		               }
	     ...
	     /* u1_input.change(function(){
	          u2_input[0].options.length=1;
			  $.getJSON("getClass",{number:$("#number").val(),courseId:u1_input.val()},function(data){
						   for(var temp in data){
						     u2_input[0].options.add(new Option(data[temp].name,data[temp].id));
						   }
...
<body>
     ...
     <div id="container" >
         <div id="title">上机系统登录</div>
     <form  id="loginForm" method="post" action="${pageContext.request.contextPath}/login">
         <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
      <table>

   <tr>
     <td colspan="2" height="25px"><font color="red">${error}<c:if test="${not empty param.error}">
         </c:if></font></td>
       ...
       <tr>
            ...
            <td style="width:310px">
                <div class="p2"><input type="text" name="number" id="number"  style="width:153px"/>
                </div>
            </td> 
      </tr>
      ...
      <tr>
             ...
             <td>
               <div class="p2"> <input type="password" id="password" name="password" style="width:153px"/>
               </div>
             </td> 
   ...
   <tr>
     <td colspan="2" height="20px">
         <a href="${pageContext.request.contextPath}/student/add">学生注册</a>　　　　　
         <a href="${pageContext.request.contextPath}/teacher/add">老师注册</a>
     </td> 
  </tr>
   <tr>
     <td colspan="2" height="20px">
    <a href="${pageContext.request.contextPath}/student/application/apply">申请加入班级</a>
     </td> 
